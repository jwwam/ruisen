...
// 获取下一个合同编号
export const getNextSequence = (signedDate: string) => {
	return request({
		url: '/rs/contract/sequenceNo',
		method: 'get',
		params: { signedDate }, // 直接传递字符串参数
	});
};
/**
 * 验证某个字段的值是否已经存在。
 ...
 *       validateExist(rule, value, callback, form.contractId !== '');
 *     },
 *     trigger: 'blur',
 *   },
 * ]
