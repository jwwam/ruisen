...
export function fetchNewList(query?: Object) {
	return request({
		url: '/rs/customerPartner/newPage',
		method: 'get',
		params: query,
	});
}
...
export function getObj(obj?: Object) {
	return request({
		url: '/rs/customerPartner/details',
		method: 'get',
		params: obj,
	});
}
 ...
 *       validateExist(rule, value, callback, form.relationId !== '');
 *     },
 *     trigger: 'blur',
 *   },
 * ]
