export default {
	job: {
		...
		filterByDate: '是否筛选时间',
		dateField: '时间字段',
		selectDateField: '请选择时间字段',
		inputDataSourceTip: '请输入数据源',
		inputTableNameTip: '请输入表名',
		inputFieldNameTip: '请输入字段名',
		selectExecuteRule: '请选择执行规则',
		sqlPreview: 'SQL预览',
		sqlPreviewTip: '根据当前配置生成的SQL语句',
		inputSqlTip: '请输入SQL语句',
	},
	log: {
		index: '#',
