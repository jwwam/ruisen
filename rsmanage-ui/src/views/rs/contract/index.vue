		...
		<div class="layout-padding-auto layout-padding-view">
			<el-row v-show="showSearch">
				<el-form :model="state.queryForm" ref="queryRef" :inline="true" @keyup.enter="getDataList">
					...
					<el-form-item label="客户名称" prop="customerId">
						<el-input placeholder="" v-model="state.queryForm.customerId" />
					</el-form-item>
					...
					<el-form-item label="签署日期" prop="signedDate">
						<el-date-picker type="date" placeholder="" v-model="state.queryForm.signedDate"></el-date-picker>
					</el-form-item>
					<el-form-item>
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					<el-button icon="folder-add" type="primary" class="ml10" @click="formDialogRef.openDialog()" v-auth="'rs_contract_add'"> 新 增 </el-button>
