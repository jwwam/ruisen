  ...
  <div class="layout-padding">
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-form-item label="客户ID" prop="customerId" >
        <el-input placeholder="请输入客户ID" v-model="state.queryForm.customerId" />
      </el-form-item>
      ...
      <el-form-item label="客户在合作伙伴平台的账号" prop="partnerAccount" >
        <el-input placeholder="请输入客户在合作伙伴平台的账号" v-model="state.queryForm.partnerAccount" />
      </el-form-item>
          <el-form-item>
      ...
      <el-row>
        <div class="mb8" style="width: 100%">
          ...
          <el-button plain :disabled="multiple" icon="Delete" type="primary"
            v-auth="'rs_customerPartner_del'" @click="handleDelete(selectObjs)">
            删 除
          </el-button>
          <right-toolbar v-model:showSearch="showSearch" :export="'rs_customerPartner_export'"
      ...
      <el-table :data="state.dataList" v-loading="state.loading" border 
        ...
        <el-table-column label="操作" width="150">
          <template #default="scope">
            <el-button icon="edit-pen" text type="primary" v-auth="'rs_customerPartner_edit'"
              @click="formDialogRef.openDialog(scope.row.relationId)">编辑</el-button>
            <el-button icon="delete" text type="primary" v-auth="'rs_customerPartner_del'" @click="handleDelete([scope.row.relationId])">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { fetchList, delObjs } from "/@/api/rs/customerPartner";
