  ...
  <div class="layout-padding">
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-form-item label="工单状态，0:待处理, 1:处理中, 2:已处理" prop="status">
            <el-select v-model="state.queryForm.status" placeholder="请选择工单状态，0:待处理, 1:处理中, 2:已处理">
      ...
      <el-row>
        <div class="mb8" style="width: 100%">
          ...
          <el-button plain :disabled="multiple" icon="Delete" type="primary"
            v-auth="'rs_work_del'" @click="handleDelete(selectObjs)">
            删 除
          </el-button>
          <right-toolbar v-model:showSearch="showSearch" :export="'rs_work_export'"
      ...
      <el-table :data="state.dataList" v-loading="state.loading" border 
        ...
        <el-table-column type="index" label="#" width="40" />
          ...
          <el-table-column prop="status" label="工单状态，0:待处理, 1:处理中, 2:已处理" show-overflow-tooltip>
      <template #default="scope">
          ...
          <el-table-column prop="attachments" label="附件路径列表，JSON格式"  show-overflow-tooltip/>
        ...
        <el-table-column label="操作" width="150">
          <template #default="scope">
            <el-button icon="edit-pen" text type="primary" v-auth="'rs_work_edit'"
              @click="formDialogRef.openDialog(scope.row.workId)">编辑</el-button>
