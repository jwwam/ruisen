 ...
 */
@Slf4j
public class RsmanageSentinelInvocationHandler implements InvocationHandler {
	...
	RsmanageSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			RsmanageSentinelInvocationHandler other = (RsmanageSentinelInvocationHandler) obj;
