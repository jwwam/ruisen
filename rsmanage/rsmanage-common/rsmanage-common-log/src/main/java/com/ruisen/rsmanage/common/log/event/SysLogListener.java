...
import com.ruisen.rsmanage.common.core.jackson.RsmanageJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final RsmanageLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new RsmanageJavaTimeModule());
	}
